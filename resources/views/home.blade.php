...
<div class="landing_container">
  ...
  <div class="text-block">
    <p>A site where you can compare, manage, and view all your job applications from different job site in an organized and centralized manner. You can apply rankings to interested jobs based on, for example, distance from home, salary, benefits etc.</p>
