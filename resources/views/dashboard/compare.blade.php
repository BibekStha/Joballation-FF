...
<div class="row my-4">
    <button class="btn back-btn col-md-1 m-0"><i class="fas fa-caret-left mr-2"></i> Back</button>
        ...
        <div class="form-inline compare-row ml-4">
            <label class="section-title col-md-1"><span class="title-bar">|</span>Date Applied</label>
        ...
        <div class="form-inline compare-row ml-4">
            ...
            <div class="form-group col-md-11">
                ...
                <div class="score-container job{{$key+1}} col-md-3">
                    <span><i class="trash-can far fa-trash-alt"></i></span>
                    <span class="compare-score{{$key+1}} float-right" data-jobid="{{$application->id}}">0</span>
                </div>
                @endforeach
            </div>
        </div>
